    ...
    Column(modifier = modifier.fillMaxSize()) {
        Box(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.enteratastaff),
                    color = Color.White,
                    fontSize = 20.sp,
        ...
        Column(
            ...
            val inputLabels = listOf(
                R.string.spokesman to "Иванов А.И.",
                R.string.sheep to "Введите номер судна",
                R.string.crew_composition to "Ввести состав"
            )
